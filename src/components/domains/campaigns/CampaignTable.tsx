...
const CampaignTable: React.FC<CampaignTableProps> = ({ data, userRole = 'viewer', onDelete, onOptimize }) => {
  if (data.length === 0) {
    return (
            ...
            >
              ...
              <td className="px-6 py-4 text-right">
                {userRole !== 'viewer' ? (
                  ...
                  <span className="text-xs text-gray-400 dark:text-gray-500 font-medium px-2">보기 전용</span>
                )}
              </td>
            </motion.tr>
          ))}
