                    ...
                    <form onSubmit={handleGenerateReport} className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="space-y-2">
                                <label htmlFor="reportName" className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('reportTitle')}</label>
                                <input
                                    id="reportName"
                                    type="text"
                                    required
                                    defaultValue={t('reportTitlePlaceholder', { brandName })}
                            ...
                            <div className="space-y-3">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('metricsTitle')}</label>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {[t('metrics.spend'), t('metrics.impressions'), t('metrics.clicks'), t('metrics.conversions'), t('metrics.roas'), t('metrics.cpc')].map((metric) => (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('dateRangeTitle')}</label>
                                    <select className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600">
                                        <option>{t('dateRanges.last30')}</option>
                                        <option>{t('dateRanges.thisMonth')}</option>
                                        <option>{t('dateRanges.lastQuarter')}</option>
                                        <option>{t('dateRanges.ytd')}</option>
                                    </select>
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('deliveryTitle')}</label>
                                    <select className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600">
                                        <option>{t('deliveryMethods.emailPdf')}</option>
                                        <option>{t('deliveryMethods.link')}</option>
                                        <option>{t('deliveryMethods.download')}</option>
                                    </select>
                                </div>
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="recipient" className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('recipientTitle')}</label>
                                <input
                                    id="recipient"
                                    type="email"
                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                        <div className="border-b border-gray-100 dark:border-gray-800 px-6 py-4">
                            <h3 className="font-semibold text-gray-900 dark:text-white">{t('previewBoxTitle')}</h3>
                        </div>
                        <div className="p-6">
                            <div className={`aspect-[4/3] rounded-xl bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 flex flex-col items-center justify-center p-6 text-center shadow-inner`}>
                                ...
                                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">{t('previewSubtitle')}</p>
                    ...
                    <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-gray-800">
                            {[
                                { title: 'Weekly Executive Summary', schedule: 'Every Monday 09:00', status: t('active') },
                                { title: 'Client Cohort Roas', schedule: '1st of Month', status: t('active') }
                            ].map((job, i) => (
